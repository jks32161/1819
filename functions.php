 ...
 */
 ...
 {
 	$content = str_ireplace('https://catalog.csun.edu/', 'http://catalog1819.wpengine.com/', $content);
 	$content = str_ireplace('http://catalog.csun.edu/', 'http://catalog1819.wpengine.com/', $content);
 	$content = str_ireplace('http://catalog.csun.edu/', 'http://catalog1819.wpengine.com/', $content);
 	$content = str_ireplace('http://catalog.csun.edu//', 'http://catalog1819.wpengine.com/', $content);
 	$content = str_ireplace('http://catalogtest.wpengine.com/', 'http://catalog1819.wpengine.com/', $content);
 	...
 	$content = str_ireplace('http://catalog.csun.edu/academics/kin/courses/kin-494ac/', 'http://catalog1819.wpengine.com/academics/kin/courses/kin-494ab/', $content);
 	...
 	$content = str_ireplace('http://catalog.csun.edu/academics/kin/courses/kin-377l/', 'http://catalog1819.wpengine.com/academics/kin/courses/kin-377/', $content);
 	$content = str_ireplace('https://csunarchive16.wpengine.com/', 'http://catalog1819.wpengine.com/archive/2016/', $content);
 	$content = str_ireplace('/academics/acct/', '/academics/acctis/', $content);
	$content = str_ireplace('https://catalog1718.wpengine.com/', 'http://catalog1819.wpengine.com/', $content);
	$content = str_ireplace('http://catalog1718.wpengine.com/', 'http://catalog1819.wpengine.com/', $content);
 	return $content;
 }
